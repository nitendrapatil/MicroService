...
public class WorkController {
	...
	public ResponseEntity<List<WorkHistory>> getWorkHistory(@PathVariable("id") String id) {
		...
		try {
			...
			workList = list.stream()
			.filter( work -> work.getEmpId().equalsIgnoreCase(id)).collect(Collectors.toList());
